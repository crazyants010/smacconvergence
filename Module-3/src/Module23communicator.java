...
private Vector<Vector<StoreInfo>> store_data =new Vector<Vector<StoreInfo>>();
...
Vector<Vector<StoreInfo>> getStore_data() {
	return store_data;
}
void setStore_data(Vector<Vector<StoreInfo>> store_data) {
